...
const query = gql`
query chongZhiLogAll($where: ChongZhiLogWhere,$order:ChongZhiLogOrder){
  chongZhiLogAll(where:$where,order:$order){
    code,
    message,
    data{
      id,
    ...
    ngOnInit() {
        this.apollo.watchQuery({
            ...
            if (res.data) {
                ...
                this.data = res.data.chongZhiLogAll.data;
            }
        })).subscribe();
    }
