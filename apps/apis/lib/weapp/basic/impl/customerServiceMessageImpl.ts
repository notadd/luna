...
import { CommonErrorResult, CustomerServiceMessage, GetTempMediaResult, ImageInput, LinkInput, MiniprogrampageInput, TextInput, UploadTempMediaResult } from "../abstract/customerServiceMessage";
