...
import { Analysis, GetDailySummaryResult, GetTrendResult, GetUserPortraitResult, GetVisitDistributionResult, GetVisitPageResult, GetVisitTrendResult } from "../abstract/analysis";
